...
; Unused: next 339 events
	...
	const EVENT_ROUTE_47_SILVER_POWDER
	...
	const EVENT_SAFARI_ZONE_AREA_4_THUNDERSTONE
	const EVENT_SAFARI_ZONE_AREA_1_MIRACLE_SEED
	const EVENT_SAFARI_ZONE_AREA_2_ULTRA_BALL
	const EVENT_SAFARI_ZONE_AREA_1_LEMONADE
	const EVENT_SAFARI_ZONE_AREA_3_HIDDEN_BIG_MUSHROOM_1
	const EVENT_SAFARI_ZONE_AREA_3_HIDDEN_BIG_MUSHROOM_2
	const EVENT_SAFARI_ZONE_AREA_2_HIDDEN_GOLD_LEAF
	const EVENT_SAFARI_ZONE_AREA_1_HIDDEN_SILVER_LEAF
	const EVENT_SAFARI_ZONE_AREA_2_CARBOS
	const EVENT_SAFARI_ZONE_AREA_3_REVIVE
	const EVENT_SAFARI_ZONE_AREA_3_PROTEIN
	const EVENT_SAFARI_ZONE_AREA_3_NUGGET
	const EVENT_SAFARI_ZONE_AREA_4_FULL_HEAL
	const EVENT_SAFARI_ZONE_AREA_4_HARD_STONE
	const EVENT_SAFARI_ZONE_AREA_4_HIDDEN_REVIVE
	const EVENT_SAFARI_ZONE_AREA_4_HIDDEN_X_ACCURACY
	const EVENT_CINNABAR_ISLAND_HIDDEN_RARE_CANDY
	const EVENT_CINNABAR_ISLAND_HIDDEN_STAR_PIECE
	const EVENT_CINNABAR_ISLAND_HIDDEN_IRON
	const EVENT_ROUTE21_HIDDEN_STARDUST1
	const EVENT_ROUTE21_HIDDEN_STARDUST2
	const EVENT_ROUTE21_HIDDEN_STARDUST3
	...
	const EVENT_POKEMON_MANSION_1F_HIDDEN_MAX_ELIXER
	const EVENT_POKEMON_MANSION_1F_CALCIUM
	const EVENT_POKEMON_MANSION_1F_ULTRA_BALL
...
; Unused: next 169 events
	...
	const EVENT_BOULDER_IN_SEAFOAM_1F_1
	const EVENT_BOULDER_IN_SEAFOAM_1F_2
	const EVENT_BOULDER_IN_SEAFOAM_B3F_3
	const EVENT_BOULDER_IN_SEAFOAM_B3F_4
	const EVENT_BOTH_BOULDERS_IN_SEAFOAM_B3F
	const EVENT_BOTH_BOULDERS_IN_SEAFOAM_B4F
	...
	const EVENT_BOULDER_IN_SEAFOAM_B4F_1
	const EVENT_BOULDER_IN_SEAFOAM_B4F_2
	const EVENT_CELEBI_ENCOUNTER
...
; Johto people
	...
	const_skip ;	Antiguo evento Bill
