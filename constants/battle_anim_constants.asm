...
; BattleAnimObjects indexes (see data/battle_anims/objects.asm)
	...
	const BATTLE_ANIM_OBJ_POKE_BALL_BG
...
; DoBattleAnimFrame arguments (see engine/battle_anims/functions.asm)
	...
	const BATTLE_ANIM_FUNC_POKEBALL_BG
...
; BattleAnimFrameData indexes (see data/battle_anims/framesets.asm)
	const_def
	const BATTLE_ANIM_FRAMSET_HIT_BIG
	const BATTLE_ANIM_FRAMSET_HIT
	const BATTLE_ANIM_FRAMSET_HIT_SMALL
	const BATTLE_ANIM_FRAMSET_PUNCH
	const BATTLE_ANIM_FRAMSET_KICK
	const BATTLE_ANIM_FRAMSET_PALM
	const BATTLE_ANIM_FRAMSET_FANG
	const BATTLE_ANIM_FRAMSET_PUNCH_SHAKE
	const BATTLE_ANIM_FRAMSET_BALL_POOF
	const BATTLE_ANIM_FRAMSET_POKE_BALL_1
	const BATTLE_ANIM_FRAMSET_POKE_BALL_2
	const BATTLE_ANIM_FRAMSET_POKE_BALL_3
	const BATTLE_ANIM_FRAMSET_POKE_BALL_4
	const BATTLE_ANIM_FRAMSET_POKE_BALL_5
	const BATTLE_ANIM_FRAMSET_DRAGON_RAGE
	const BATTLE_ANIM_FRAMSET_FLAMETHROWER
	const BATTLE_ANIM_FRAMSET_EMBER
	const BATTLE_ANIM_FRAMSET_BURNED
	const BATTLE_ANIM_FRAMSET_BLIZZARD
	const BATTLE_ANIM_FRAMSET_ICE
	const BATTLE_ANIM_FRAMSET_ICE_BEAM
	const BATTLE_ANIM_FRAMSET_POWDER_SNOW
	const BATTLE_ANIM_FRAMSET_RAZOR_LEAF_1
	const BATTLE_ANIM_FRAMSET_RAZOR_LEAF_2
	const BATTLE_ANIM_FRAMSET_EXPLOSION
	const BATTLE_ANIM_FRAMSET_BIG_ROCK
	const BATTLE_ANIM_FRAMSET_SMALL_ROCK
	const BATTLE_ANIM_FRAMSET_STRENGTH
	const BATTLE_ANIM_FRAMSET_SKULL_CROSSBONE
	const BATTLE_ANIM_FRAMSET_ACID
	const BATTLE_ANIM_FRAMSET_POISON_DROPLET_UNUSED
	const BATTLE_ANIM_FRAMSET_SLUDGE_BUBBLE
	const BATTLE_ANIM_FRAMSET_SLUDGE_BUBBLE_BURST
	const BATTLE_ANIM_FRAMSET_SMALL_BUBBLE
	const BATTLE_ANIM_FRAMSET_PULSING_BUBBLE
	const BATTLE_ANIM_FRAMSET_SURF
	const BATTLE_ANIM_FRAMSET_MUSIC_NOTE_1
	const BATTLE_ANIM_FRAMSET_MUSIC_NOTE_2
	const BATTLE_ANIM_FRAMSET_MUSIC_NOTE_3
	const BATTLE_ANIM_FRAMSET_WATER_GUN_1
	const BATTLE_ANIM_FRAMSET_WATER_GUN_2
	const BATTLE_ANIM_FRAMSET_WATER_GUN_3
	const BATTLE_ANIM_FRAMSET_HYDRO_PUMP
	const BATTLE_ANIM_FRAMSET_POWDER
	const BATTLE_ANIM_FRAMSET_BEAM
	const BATTLE_ANIM_FRAMSET_BEAM_TIP
	const BATTLE_ANIM_FRAMSET_ICE_BUILDUP
	const BATTLE_ANIM_FRAMSET_FROZEN
	const BATTLE_ANIM_FRAMSET_CIRCLING_SPARKLE
	const BATTLE_ANIM_FRAMSET_THUNDER_CENTER
	const BATTLE_ANIM_FRAMSET_THUNDER_LEFT
	const BATTLE_ANIM_FRAMSET_THUNDER_RIGHT
	const BATTLE_ANIM_FRAMSET_THUNDER_WAVE_DISABLE
	const BATTLE_ANIM_FRAMSET_THUNDER_WAVE_EXTRA
	const BATTLE_ANIM_FRAMSET_THUNDERBOLT_SPARKS
	const BATTLE_ANIM_FRAMSET_THUNDERBOLT_CORE
	const BATTLE_ANIM_FRAMSET_THUNDERSHOCK_SPARKS
	const BATTLE_ANIM_FRAMSET_THUNDERSHOCK_CORE
	const BATTLE_ANIM_FRAMSET_CLAMP
	const BATTLE_ANIM_FRAMSET_CLAMP_FLIPPED
	const BATTLE_ANIM_FRAMSET_BITE_1
	const BATTLE_ANIM_FRAMSET_BITE_2
	const BATTLE_ANIM_FRAMSET_CUT_DOWN_LEFT
	const BATTLE_ANIM_FRAMSET_CUT_DOWN_RIGHT
	const BATTLE_ANIM_FRAMSET_CUT_UP_RIGHT
	const BATTLE_ANIM_FRAMSET_CUT_LONG_DOWN_LEFT
	const BATTLE_ANIM_FRAMSET_CUT_LONG_DOWN_RIGHT
	const BATTLE_ANIM_FRAMSET_CHARGE_ORB_1
	const BATTLE_ANIM_FRAMSET_ABSORB_CENTER
	const BATTLE_ANIM_FRAMSET_GUST
	const BATTLE_ANIM_FRAMSET_VINE_WHIP_1
	const BATTLE_ANIM_FRAMSET_VINE_WHIP_2
	const BATTLE_ANIM_FRAMSET_RAZOR_WIND_1
	const BATTLE_ANIM_FRAMSET_RAZOR_WIND_2
	const BATTLE_ANIM_FRAMSET_SONICBOOM_JP
	const BATTLE_ANIM_FRAMSET_WARP
	const BATTLE_ANIM_FRAMSET_CHARGE_ORB_2
	const BATTLE_ANIM_FRAMSET_EGG
	const BATTLE_ANIM_FRAMSET_EGG_WOBBLE
	const BATTLE_ANIM_FRAMSET_EGG_CRACKED_TOP
	const BATTLE_ANIM_FRAMSET_EGG_CRACKED_BOTTOM
	const BATTLE_ANIM_FRAMSET_FOCUS
	const BATTLE_ANIM_FRAMSET_BIND_1
	const BATTLE_ANIM_FRAMSET_BIND_2
	const BATTLE_ANIM_FRAMSET_BIND_3
	const BATTLE_ANIM_FRAMSET_BIND_4
	const BATTLE_ANIM_FRAMSET_LEECH_SEED_1
	const BATTLE_ANIM_FRAMSET_LEECH_SEED_2
	const BATTLE_ANIM_FRAMSET_LEECH_SEED_3
	const BATTLE_ANIM_FRAMSET_SOUND_1
	const BATTLE_ANIM_FRAMSET_SOUND_2
	const BATTLE_ANIM_FRAMSET_SOUND_3
	const BATTLE_ANIM_FRAMSET_WAVE
	const BATTLE_ANIM_FRAMSET_CONFUSE_RAY_1
	const BATTLE_ANIM_FRAMSET_CONFUSE_RAY_2
	const BATTLE_ANIM_FRAMSET_LEER
	const BATTLE_ANIM_FRAMSET_REFLECT
	const BATTLE_ANIM_FRAMSET_CHICK_1
	const BATTLE_ANIM_FRAMSET_CHICK_2
	const BATTLE_ANIM_FRAMSET_AMNESIA_1
	const BATTLE_ANIM_FRAMSET_AMNESIA_2
	const BATTLE_ANIM_FRAMSET_AMNESIA_3
	const BATTLE_ANIM_FRAMSET_ASLEEP
	const BATTLE_ANIM_FRAMSET_DIG_SAND
	const BATTLE_ANIM_FRAMSET_DIG_PILE
	const BATTLE_ANIM_FRAMSET_SAND
	const BATTLE_ANIM_FRAMSET_STRING_SHOT_1
	const BATTLE_ANIM_FRAMSET_STRING_SHOT_2
	const BATTLE_ANIM_FRAMSET_STRING_SHOT_3
	const BATTLE_ANIM_FRAMSET_PARALYZED
	const BATTLE_ANIM_FRAMSET_PARALYZED_FLIPPED
	const BATTLE_ANIM_FRAMSET_HAZE
	const BATTLE_ANIM_FRAMSET_MIST
	const BATTLE_ANIM_FRAMSET_HORN
	const BATTLE_ANIM_FRAMSET_NEEDLE
	const BATTLE_ANIM_FRAMSET_FLOWER
	const BATTLE_ANIM_FRAMSET_BARRAGE_BALL
	const BATTLE_ANIM_FRAMSET_PAY_DAY
	const BATTLE_ANIM_FRAMSET_HEART
	const BATTLE_ANIM_FRAMSET_SPINNING_BONE
	const BATTLE_ANIM_FRAMSET_STAR
	const BATTLE_ANIM_FRAMSET_SPOON
	const BATTLE_ANIM_FRAMSET_SPARKLE
	const BATTLE_ANIM_FRAMSET_SKY_ATTACK
	const BATTLE_ANIM_FRAMSET_LICK
	const BATTLE_ANIM_FRAMSET_WITHDRAW_SHELL
	const BATTLE_ANIM_FRAMSET_SHRINKING_CHARGE_ORB
	const BATTLE_ANIM_FRAMSET_CONVERSION
	const BATTLE_ANIM_FRAMSET_SWORD
	const BATTLE_ANIM_FRAMSET_SPEED_LINE_1
	const BATTLE_ANIM_FRAMSET_SPEED_LINE_2
	const BATTLE_ANIM_FRAMSET_SPEED_LINE_3
	const BATTLE_ANIM_FRAMSET_SEISMIC_TOSS
	const BATTLE_ANIM_FRAMSET_SHARPEN
	const BATTLE_ANIM_FRAMSET_DEFENSE_CURL
	const BATTLE_ANIM_FRAMSET_METRONOME_HAND
	const BATTLE_ANIM_FRAMSET_AGILITY
	const BATTLE_ANIM_FRAMSET_COTTON
	const BATTLE_ANIM_FRAMSET_MILK_BOTTLE
	const BATTLE_ANIM_FRAMSET_SPIKE
	const BATTLE_ANIM_FRAMSET_ANGER_VEIN
	const BATTLE_ANIM_FRAMSET_HEAL_BELL
	const BATTLE_ANIM_FRAMSET_BATON_PASS
	const BATTLE_ANIM_FRAMSET_LOCK_ON_1
	const BATTLE_ANIM_FRAMSET_LOCK_ON_2
	const BATTLE_ANIM_FRAMSET_LOCK_ON_3
	const BATTLE_ANIM_FRAMSET_LOCK_ON_4
	const BATTLE_ANIM_FRAMSET_MIND_READER_1
	const BATTLE_ANIM_FRAMSET_MIND_READER_2
	const BATTLE_ANIM_FRAMSET_MIND_READER_3
	const BATTLE_ANIM_FRAMSET_MIND_READER_4
	const BATTLE_ANIM_FRAMSET_SAFEGUARD
	const BATTLE_ANIM_FRAMSET_MEGAPHONE_UNUSED
	const BATTLE_ANIM_FRAMSET_ITEM_BAG
	const BATTLE_ANIM_FRAMSET_SPIDER_WEB
	const BATTLE_ANIM_FRAMSET_UNUSED_CAKE
	const BATTLE_ANIM_FRAMSET_IMP
	const BATTLE_ANIM_FRAMSET_IMP_FLIPPED
	const BATTLE_ANIM_FRAMSET_CHERUB
	const BATTLE_ANIM_FRAMSET_PENCIL
	const BATTLE_ANIM_FRAMSET_ENCORE_HAND
	const BATTLE_ANIM_FRAMSET_ENCORE_HAND_FLIPPED
	const BATTLE_ANIM_FRAMSET_DESTINY_BOND
	const BATTLE_ANIM_FRAMSET_MORNING_SUN
	const BATTLE_ANIM_FRAMSET_GLIMMER
	const BATTLE_ANIM_FRAMSET_MOONLIGHT
	const BATTLE_ANIM_FRAMSET_CROSS_CHOP_1
	const BATTLE_ANIM_FRAMSET_CROSS_CHOP_2
	const BATTLE_ANIM_FRAMSET_ZAP_CANNON
	const BATTLE_ANIM_FRAMSET_CURSE_NAIL
	const BATTLE_ANIM_FRAMSET_FORESIGHT_SHINE
	const BATTLE_ANIM_FRAMSET_RAPID_SPIN
	const BATTLE_ANIM_FRAMSET_SWAGGER
	const BATTLE_ANIM_FRAMSET_MEAN_LOOK
	const BATTLE_ANIM_FRAMSET_UPSIDE_DOWN_PUNCH
	const BATTLE_ANIM_FRAMSET_GROWING_SPARKLE
	const BATTLE_ANIM_FRAMSET_RAIN
	const BATTLE_ANIM_FRAMSET_PSYCH_UP
	const BATTLE_ANIM_FRAMSET_SPIRAL_UNUSED
	const BATTLE_ANIM_FRAMSET_AEROBLAST
	const BATTLE_ANIM_FRAMSET_SANDSTORM
	const BATTLE_ANIM_FRAMSET_ENEMYFEET_1ROW
	const BATTLE_ANIM_FRAMSET_PLAYERHEAD_1ROW
	const BATTLE_ANIM_FRAMSET_ENEMYFEET_2ROW
	const BATTLE_ANIM_FRAMSET_PLAYERHEAD_2ROW
...
; AnimObjGFX indexes (see data/battle_anims/object_gfx.asm)
	...
	const BATTLE_ANIM_GFX_POKE_BALL_BG
