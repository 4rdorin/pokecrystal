...
; shiny dvs
DEF ATKDEFDV_SHINY EQU $CD
DEF DV_SHINY EQU $FD
DEF DV_SHINY2 EQU $ED
DEF DV_SHINY3 EQU $1D
...
DEF BATTLERESULT_CAUGHT_POKEMON_F EQU 6
DEF BATTLERESULT_BOX_FULL EQU 7
DEF BATTLERESULT_BITMASK EQU (1 << BATTLERESULT_CAUGHT_POKEMON_F) | (1 << BATTLERESULT_BOX_FULL)
