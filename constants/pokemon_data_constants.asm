...
; TreeMons indexes (see data/wild/treemons.asm)
	...
	const TREEMON_SET_PLAINS
	const TREEMON_SET_LAKE
	const TREEMON_SET_FOREST
	const TREEMON_SET_SAFARI
	const TREEMON_SET_CENTRAL_KANTO
	const TREEMON_SET_WESTERN_KANTO
	const TREEMON_SET_SOUTHERN_KANTO
	const TREEMON_SET_NORTHERN_KANTO
	const TREEMON_SET_MEDOWS_KANTO
	const TREEMON_SET_MT_SILVER
...
; const TREEMON_SET_ROCK is originally within NUM_TREEMON_SETS
	...
	const TREEMON_SET_BURNED_TOWER
