	...
	const POKEMON_MANSION_B1F_MOLTRES
...
.Appear:
	appear POKEMON_MANSION_B1F_MOLTRES
	endcallback

.NoAppear:
	disappear POKEMON_MANSION_B1F_MOLTRES
	endcallback
...
.StoneTable:
	stonetable 2, POKEMON_MANSION_B1F_BOULDER1+1, .Boulder1
	stonetable 3, POKEMON_MANSION_B1F_BOULDER2+1, .Boulder2
	stonetable 4, POKEMON_MANSION_B1F_BOULDER3+1, .Boulder3
	db -1 ; end
...
PokemonMansionB1F_MapEvents:
	...
	object_event  4,  2, SPRITE_MOLTRES, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, CinnabarVolcanoMoltres, EVENT_MOLTRES_APPEAR
