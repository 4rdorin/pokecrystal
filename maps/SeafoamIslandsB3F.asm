...
.StoneTable:
	stonetable 9, SEAFOAMISLANDSB3F_BOULDER3+1, .Boulder1
	stonetable 8, SEAFOAMISLANDSB3F_BOULDER4+1, .Boulder2
	db -1 ; end
...
SeafoamIslandsB3FBoulder:	;ToDo: Revisar
...
SeafoamIslandsB3F_MapEvents:
	...
	warp_event 11,  9, SEAFOAM_ISLANDS_B4F, 1
