...
VioletKylesHouse_MapEvents:
	...
	object_event  0,  2, SPRITE_MOM, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 2, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, VioletKylesHouseTrader, -1
