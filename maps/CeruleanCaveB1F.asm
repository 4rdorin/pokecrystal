...
CeruleanCaveB1FMewtwo:
	...
	loadwildmon MEWTWO, 60 ;ToDo: Revisar
	startbattle
...
CeruleanCaveB1F_MapEvents:
	...
	object_event 34, 17, SPRITE_MEWTWO, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_TREE, OBJECTTYPE_SCRIPT, 0,  CeruleanCaveB1FMewtwo, EVENT_MEWTWO_APPEAR
