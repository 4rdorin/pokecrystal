...
SafariZoneArea4_MapEvents:
	...
	def_object_events
	object_event 27, 43, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, SafariZoneArea4FullHeal, EVENT_SAFARI_ZONE_AREA_4_FULL_HEAL
	object_event 18, 20, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, SafariZoneArea4HardStone, EVENT_SAFARI_ZONE_AREA_4_HARD_STONE
	object_event  8, 33, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, SafariZoneArea4ThunderStone, EVENT_SAFARI_ZONE_AREA_4_THUNDERSTONE
