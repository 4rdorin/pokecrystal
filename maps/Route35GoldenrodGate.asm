	...
	const ROUTE35GOLDENRODGATE_ELMS_AIDE
...
Route35GoldenrodGateElmsAideScript:
	faceplayer
	opentext
	...
	writetext Route35GoldenrodGateGiveExpShareText
	promptbutton
...
.NoPlainBadge
	writetext Route35GoldenrodGateGet3BadgesText
	waitbutton
	closetext
	end

.GotExpShare
	writetext Route35GoldenrodGotExpShareText
	waitbutton
	closetext
	end
...
Route35GoldenrodGateGiveExpShareText:
	text "Hi <PLAY_G>."

	para "You already have 3"
	line "badges!"

	para "Take this item, it"
	line "will help you in"
	cont "your adventure."
	done

Route35GoldenrodGateGet3BadgesText:
	text "Hi <PLAY_G>."
	...
	line "an useful item"
	cont "if you beat Blanca."
	done

Route35GoldenrodGotExpShareText:
	text "Hi <PLAY_G>."

	para "The Exp Share is a"
	line "very useful item!"
	done
...
Route35GoldenrodGate_MapEvents:
	...
	object_event  9,  4, SPRITE_SCIENTIST, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, Route35GoldenrodGateElmsAideScript, -1
