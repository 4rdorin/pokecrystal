...
Route42_MapEvents:
	...
	warp_event 10,  1, MOUNT_MORTAR_1F_OUTSIDE, 1
	warp_event 28,  7, MOUNT_MORTAR_1F_OUTSIDE, 2
	warp_event 49,  1, MOUNT_MORTAR_1F_OUTSIDE, 3

	def_coord_events
	coord_event 24, 14, SCENE_ROUTE42_SUICUNE, Route42SuicuneScript

	def_bg_events
	bg_event  3,  9, BGEVENT_READ, Route42Sign1
	bg_event 25,  9, BGEVENT_READ, MtMortarSign1
	bg_event 45,  9, BGEVENT_READ, MtMortarSign2
	bg_event 54,  8, BGEVENT_READ, Route42Sign2
	bg_event 13,  5, BGEVENT_ITEM, Route42HiddenMaxPotion
	...
	object_event 14, 14, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route42UltraBall, EVENT_ROUTE_42_ULTRA_BALL
