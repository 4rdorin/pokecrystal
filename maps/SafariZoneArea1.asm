...
SafariZoneArea1_MapEvents:
	...
	def_object_events
	object_event 27,  7, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, SafariZoneArea1MiracleSeed, EVENT_SAFARI_ZONE_AREA_1_MIRACLE_SEED
	object_event 17, 18, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, SafariZoneArea1Lemonade, EVENT_SAFARI_ZONE_AREA_1_LEMONADE
