InitialEvents:
	...
	dw EVENT_BOULDER_IN_SEAFOAM_B1F_1
	dw EVENT_BOULDER_IN_SEAFOAM_B1F_2
	dw EVENT_BOULDER_IN_SEAFOAM_B2F_1
	dw EVENT_BOULDER_IN_SEAFOAM_B2F_2
	dw EVENT_BOULDER_IN_SEAFOAM_B3F_1
	dw EVENT_BOULDER_IN_SEAFOAM_B3F_2
	dw EVENT_BOULDER_IN_SEAFOAM_B4F_1
	dw EVENT_BOULDER_IN_SEAFOAM_B4F_2
