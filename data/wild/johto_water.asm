...
JohtoWaterWildMons:
	...
	;  %, species,     min, max
	db 60, WOOPER, 		15, 20
	db 30, QUAGSIRE, 	15, 25
	db 10, QUAGSIRE, 	15, 25
	end_water_wildmons
	...
	;  %, species,     min, max
	db 60, TENTACOOL,	15, 20
	db 30, QUAGSIRE,	20, 25
	db 10, TENTACRUEL,	20, 25
	end_water_wildmons

	def_water_wildmons SLOWPOKE_WELL_B1F
	db 2 percent ; encounter rate
	;  %, species,     min, max
	db 60, SLOWPOKE, 	10, 25
	db 30, SLOWPOKE, 	10, 25
	db 10, SLOWPOKE, 	10, 25
	end_water_wildmons

	def_water_wildmons SLOWPOKE_WELL_B2F
	db 2 percent ; encounter rate
	;  %, species,    min, max
	db 60, SLOWPOKE, 	15, 20
	db 30, SLOWPOKE, 	15, 20
	db 10, SLOWBRO, 	20, 25
	end_water_wildmons
	...
	db 2 percent ; encounter rate
	;  %, species,    min, max
	db 60, TENTACOOL,	15, 25
	db 30, TENTACOOL,	15, 25
	db 10, TENTACRUEL,	20, 25
	end_water_wildmons
	...
	db 2 percent ; encounter rate
	;  %, species,    min, max
	db 60, MAGIKARP,	10, 25
	db 30, MAGIKARP,	10, 25
	db 10, MAGIKARP,	10, 25
	end_water_wildmons
	...
	db 6 percent ; encounter rate
	;  %, species,    min, max
	db 60, MAGIKARP,	10, 20
	db 30, MAGIKARP,	10, 20
	db 10, GYARADOS,	15, 20
	end_water_wildmons
	...
	db 2 percent ; encounter rate
	;  %, species,    min, max
	db 90, POLIWHIRL,	45, 50
	db  5, POLIWRATH,	45, 50
	db  5, POLITOED,	45, 50
	end_water_wildmons
