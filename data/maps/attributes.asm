...
ENDM
	...
	map_attributes Route34, ROUTE_34, $05, NORTH | WEST | EAST
	...
	connection south, IlexBeach, ILEX_BEACH, 0
	connection east, Route34, ROUTE_34, 0

	map_attributes IlexBeach, ILEX_BEACH, $35, NORTH
	...
	connection west, Route20, ROUTE_20, 16
	...
	connection east, Route10North, ROUTE_10_NORTH, -1
	...
	connection east, Route4, ROUTE_4, 1
	...
	connection west, SaffronCity, SAFFRON_CITY, -6
	...
	connection west, Route9, ROUTE_9, 1
	...
	map_attributes GoldenrodHarborGate, GOLDENROD_HARBOR_GATE, $00, 0
