...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move DOUBLESLAP,   EFFECT_MULTI_HIT,          15, NORMAL,        PHYSICAL,  95, 10,   0
	move COMET_PUNCH,  EFFECT_MULTI_HIT,          18, NORMAL,        PHYSICAL,  90, 15,   0
	move MEGA_PUNCH,   EFFECT_NORMAL_HIT,         95, FIGHTING,      PHYSICAL, 100, 20,   0
	move PAY_DAY,      EFFECT_PAY_DAY,            40, NORMAL,        PHYSICAL, 100, 20,   0
	move FIRE_PUNCH,   EFFECT_BURN_HIT,           75, FIRE,          SPECIAL, 100, 15,  10
	move ICE_PUNCH,    EFFECT_FREEZE_HIT,         75, ICE,           SPECIAL, 100, 15,  10
	...
	move VICEGRIP,     EFFECT_NORMAL_HIT,         65, NORMAL,        PHYSICAL, 100, 30,   0
	...
	move CUT,          EFFECT_NORMAL_HIT,         60, BUG,           PHYSICAL, 100, 30,   0
	move GUST,         EFFECT_GUST,               40, FLYING,        PHYSICAL, 100, 35,   0
	move WING_ATTACK,  EFFECT_NORMAL_HIT,         80, FLYING,        PHYSICAL, 100, 35,   0
	...
	move SLAM,         EFFECT_NORMAL_HIT,         80, NORMAL,        PHYSICAL, 85, 20,   0
	move VINE_WHIP,    EFFECT_NORMAL_HIT,         40, GRASS,         SPECIAL, 100, 10,   0
	move STOMP,        EFFECT_STOMP,              65, NORMAL,        PHYSICAL, 100, 20,  30
	move DOUBLE_KICK,  EFFECT_DOUBLE_HIT,         30, FIGHTING,      PHYSICAL, 100, 30,   0
	move MEGA_KICK,    EFFECT_NORMAL_HIT,         95, FIGHTING,      PHYSICAL, 100,  5,   0
	...
	move FURY_ATTACK,  EFFECT_MULTI_HIT,          15, NORMAL,        PHYSICAL,  95, 20,   0
	...
	move POISON_STING, EFFECT_POISON_HIT,         30, POISON,        PHYSICAL, 100, 35,  30
	move TWINEEDLE,    EFFECT_POISON_MULTI_HIT,   25, BUG,           PHYSICAL, 100, 20,  20
	move PIN_MISSILE,  EFFECT_MULTI_HIT,          18, BUG,           PHYSICAL,  90, 20,   0
	move LEER,         EFFECT_DEFENSE_DOWN,        0, NORMAL,        STATUS,   100, 30,   0
	move BITE,         EFFECT_FLINCH_HIT,         60, DARK,          SPECIAL,  100, 25,  30
	...
	move DRILL_PECK,   EFFECT_NORMAL_HIT,         90, FLYING,        PHYSICAL, 100, 20,   0
	...
	move MEGA_DRAIN,   EFFECT_LEECH_HIT,          55, GRASS,         SPECIAL,  100, 15,   0
	...
	move SMOG,         EFFECT_POISON_HIT,         25, POISON,        PHYSICAL,   90, 20,  40
	...
	move CLAMP,        EFFECT_TRAP_TARGET,        35, WATER,         SPECIAL,  75, 10,   0
	...
	move CONSTRICT,    EFFECT_SPEED_DOWN_HIT,     60, NORMAL,        PHYSICAL, 100, 35,  100
	...
	move BUBBLE,       EFFECT_SPEED_DOWN_HIT,     30, WATER,         SPECIAL,  100, 30,  30
	...
	move PSYWAVE,      EFFECT_PSYWAVE,             1, PSYCHIC_TYPE,  SPECIAL,   95, 15,   0
	move SPLASH,       EFFECT_SPLASH,              0, NORMAL,        STATUS,   100, 40,   0
	move ACID_ARMOR,   EFFECT_DEFENSE_UP_2,        0, POISON,        STATUS,   100, 40,   0
	move CRABHAMMER,   EFFECT_NORMAL_HIT,         90, WATER,         PHYSICAL,  95, 10,   0
	...
	move HYPER_FANG,   EFFECT_FLINCH_HIT,         80, NORMAL,        PHYSICAL,  95, 15,  10
	...
	move TRIPLE_KICK,  EFFECT_TRIPLE_KICK,        17, FIGHTING,      PHYSICAL,  90, 10,   0
	move THIEF,        EFFECT_THIEF,              40, DARK,          SPECIAL,  100, 10, 100
	...
	move FLAME_WHEEL,  EFFECT_FLAME_WHEEL,        60, FIRE,          SPECIAL, 100, 25,  10
	...
	move AEROBLAST,    EFFECT_NORMAL_HIT,        100, FLYING,        PHYSICAL,   95,  10,   0
	...
	move OCTAZOOKA,    EFFECT_ACCURACY_DOWN_HIT,  80, WATER,         SPECIAL,  100, 10,  30
	...
	move BONE_RUSH,    EFFECT_MULTI_HIT,          25, GROUND,        PHYSICAL,  85, 10,   0
	move LOCK_ON,      EFFECT_LOCK_ON,             0, NORMAL,        STATUS,   100,  5,   0
	move OUTRAGE,      EFFECT_RAMPAGE,           120, DRAGON,        SPECIAL,  100, 15,   0
	...
	move SACRED_FIRE,  EFFECT_SACRED_FIRE,       100, FIRE,          SPECIAL,  95,  10,  50
	...
	move PURSUIT,      EFFECT_PURSUIT,            40, DARK,          SPECIAL,  100, 20,   0
	...
	move METAL_CLAW,   EFFECT_ATTACK_UP_HIT,      70, STEEL,         PHYSICAL, 100, 35,  10
	...
	move MOONLIGHT,    EFFECT_MOONLIGHT,           0, NORMAL,        STATUS,   100, 10,   0
	...
	move ANCIENTPOWER, EFFECT_ALL_UP_HIT,         60, ROCK,          PHYSICAL,  100,  5,  10
	move SHADOW_BALL,  EFFECT_SP_DEF_DOWN_HIT,    80, GHOST,         PHYSICAL,  100, 15,  20
	...
	move BEAT_UP,      EFFECT_BEAT_UP,             0, DARK,          PHYSICAL,  100, 10,   0
