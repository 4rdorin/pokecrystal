...
BattleAnim_ThrowPokeBall:
	...
	; any other ball
	anim_3gfx BATTLE_ANIM_GFX_POKE_BALL, BATTLE_ANIM_GFX_POKE_BALL_BG, BATTLE_ANIM_GFX_SMOKE
	anim_sound 6, 2, SFX_THROW_BALL
	anim_obj BATTLE_ANIM_OBJ_POKE_BALL, 68, 92, $40
	anim_obj BATTLE_ANIM_OBJ_POKE_BALL_BG, 68, 92, $40
	anim_wait 36
	anim_obj BATTLE_ANIM_OBJ_POKE_BALL, 136, 65, $0
	anim_setobj $3, $7
	anim_obj BATTLE_ANIM_OBJ_POKE_BALL_BG, 136, 65, $0
	anim_setobj $4, $7
	anim_wait 16
...
.MasterBall:
	...
	anim_obj BATTLE_ANIM_OBJ_POKE_BALL_BG, 64, 92, $20
	anim_wait 36
	anim_obj BATTLE_ANIM_OBJ_POKE_BALL, 136, 65, $0
	anim_setobj $3, $7
	anim_obj BATTLE_ANIM_OBJ_POKE_BALL_BG, 136, 65, $0
...
BattleAnim_HiddenPower:
	...
	anim_if_param_equal $06, .bug
	anim_if_param_equal $07, .ghost
	anim_if_param_equal $08, .steel
	anim_if_param_equal $0a, .fire
	anim_if_param_equal $0b, .water
	anim_if_param_equal $0c, .grass
	anim_if_param_equal $0d, .electric
	anim_if_param_equal $0e, .psychic
	anim_if_param_equal $0f, .ice
	anim_if_param_equal $10, .dragon
	anim_if_param_equal $11, .dark
.fighting
