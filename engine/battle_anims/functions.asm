...
.one
	...
	add [hl]
	ld [hl], a
	ld a, BATTLE_ANIM_FRAMSET_POKE_BALL_3
	call ReinitBattleAnimFrameset
	jmp BattleAnim_IncAnonJumptableIndex

.three
	call BattleAnim_IncAnonJumptableIndex
	ld a, BATTLE_ANIM_FRAMSET_POKE_BALL_1
	call ReinitBattleAnimFrameset
	ld hl, BATTLEANIMSTRUCT_VAR1
	add hl, bc
	ld [hl], $0
...
.four
	...
	ld [hl], a
	ret nz
	ld a, BATTLE_ANIM_FRAMSET_POKE_BALL_4
	call ReinitBattleAnimFrameset
	jmp BattleAnim_IncAnonJumptableIndex

.six
	ld a, BATTLE_ANIM_FRAMSET_POKE_BALL_5
	call ReinitBattleAnimFrameset
...
.seven
	call GetBallAnimPal
	ld a, BATTLE_ANIM_FRAMSET_POKE_BALL_2
	call ReinitBattleAnimFrameset
	call BattleAnim_IncAnonJumptableIndex
	ld hl, BATTLEANIMSTRUCT_VAR2
	add hl, bc
...
.three
	call BattleAnim_IncAnonJumptableIndex
	ld a, BATTLE_ANIM_FRAMSET_FLAMETHROWER
...
.zero
	...
	cp $7
	jr z, .seven
	ld a, BATTLE_ANIM_FRAMSET_BURNED
	jmp ReinitBattleAnimFrameset
...
.set_up_eight
	call BattleAnim_IncAnonJumptableIndex
	ld a, BATTLE_ANIM_FRAMSET_EMBER
	call ReinitBattleAnimFrameset
.eight
	ld hl, BATTLEANIMSTRUCT_VAR1
	add hl, bc
...
.one
	...
	ld [hli], a
	ld [hl], a
	ld a, BATTLE_ANIM_FRAMSET_RAZOR_LEAF_2
	call ReinitBattleAnimFrameset
	ld hl, BATTLEANIMSTRUCT_PARAM
	add hl, bc
	bit 6, [hl]
...
.three
	ld a, BATTLE_ANIM_FRAMSET_RAZOR_LEAF_1
	call ReinitBattleAnimFrameset
...
.zero
	...
	rlca
	rlca
	add BATTLE_ANIM_FRAMSET_BIG_ROCK
...
.next
	...
	add hl, bc
	ld [hl], $0
	ld a, BATTLE_ANIM_FRAMSET_PULSING_BUBBLE
	call ReinitBattleAnimFrameset
.two
	ld hl, BATTLEANIMSTRUCT_XCOORD
	add hl, bc
...
.zero
	...
	ld hl, BATTLEANIMSTRUCT_PARAM
	add hl, bc
	ld a, BATTLE_ANIM_FRAMSET_MUSIC_NOTE_1
	add [hl] ; BATTLE_ANIM_FRAMSET_MUSIC_NOTE_2 BATTLE_ANIM_FRAMSET_MUSIC_NOTE_3
	call ReinitBattleAnimFrameset
...
.run_down
	call BattleAnim_IncAnonJumptableIndex
	ld a, BATTLE_ANIM_FRAMSET_WATER_GUN_2
	call ReinitBattleAnimFrameset
	ld hl, BATTLEANIMSTRUCT_YOFFSET
	add hl, bc
	ld [hl], $0
...
.splash
	call BattleAnim_IncAnonJumptableIndex
	ld a, BATTLE_ANIM_FRAMSET_WATER_GUN_3
	jmp ReinitBattleAnimFrameset
...
.one
	call BattleAnim_IncAnonJumptableIndex
	ld a, BATTLE_ANIM_FRAMSET_THUNDER_WAVE_EXTRA
	jmp ReinitBattleAnimFrameset
...
.one
	...
	add hl, bc
	ld a, [hl]
	inc a ; BATTLE_ANIM_FRAMSET_3B (Clamp Flipped)
	      ; BATTLE_ANIM_FRAMSET_A1 (Hands Flipped)
	jr .reinit

.load_no_inc
	ld hl, BATTLEANIMSTRUCT_VAR2
	add hl, bc
	ld a, [hl] ; BATTLE_ANIM_FRAMSET_3A (Clamp)
	           ; BATTLE_ANIM_FRAMSET_A0 (Hands)
.reinit
	call ReinitBattleAnimFrameset
	ld hl, BATTLEANIMSTRUCT_VAR1
	add hl, bc
...
.one
	...
	bit 7, a
	jr nz, .flipped2
	ld a, BATTLE_ANIM_FRAMSET_BITE_2
	jr .got_frameset

.flipped2
	ld a, BATTLE_ANIM_FRAMSET_BITE_1
.got_frameset
	call ReinitBattleAnimFrameset
	ld hl, BATTLEANIMSTRUCT_VAR1
	add hl, bc
...
.one
	...
	add hl, bc
	ld a, [hl]
	inc a ; BATTLE_ANIM_FRAMSET_BIND_2
	      ; BATTLE_ANIM_FRAMSET_BIND_4
	call ReinitBattleAnimFrameset
	call BattleAnim_IncAnonJumptableIndex
...
.one
	...
	ld [hl], $40
	ld a, BATTLE_ANIM_FRAMSET_LEECH_SEED_2
	call ReinitBattleAnimFrameset
	jmp BattleAnim_IncAnonJumptableIndex
...
.flutter
	call BattleAnim_IncAnonJumptableIndex
	ld a, BATTLE_ANIM_FRAMSET_LEECH_SEED_3
	jmp ReinitBattleAnimFrameset
...
.seven
	...
	ld a, BATTLE_ANIM_FRAMSET_EGG_WOBBLE ; Egg wobbling
	call ReinitBattleAnimFrameset
	jmp BattleAnim_IncAnonJumptableIndex
...
.nine
	...
	ld a, BATTLE_ANIM_FRAMSET_EGG_CRACKED_BOTTOM ; Cracked egg bottom
	call ReinitBattleAnimFrameset
	ld hl, BATTLEANIMSTRUCT_YOFFSET
	add hl, bc
	ld [hl], $4
...
.eleven
	...
	ld a, BATTLE_ANIM_FRAMSET_EGG_CRACKED_TOP ; Cracked egg top
	call ReinitBattleAnimFrameset
	call BattleAnim_IncAnonJumptableIndex
	ld hl, BATTLEANIMSTRUCT_VAR1
	add hl, bc
...
; Obj Param: Used to define object angle. How much to increase from base frameset, which is hardcoded as BATTLE_ANIM_FRAMSET_SOUND_1
	call BattleAnim_AnonJumptable
.anon_dw
	dw .zero
	dw .one
...
.got_turn
	...
	ld hl, BATTLEANIMSTRUCT_PARAM
	add hl, bc
	ld a, BATTLE_ANIM_FRAMSET_SOUND_1
	add [hl] ; BATTLE_ANIM_FRAMSET_SOUND_2 BATTLE_ANIM_FRAMSET_SOUND_3
	jmp ReinitBattleAnimFrameset
...
.zero
	...
	rlca
	ld [hl], a
	add BATTLE_ANIM_FRAMSET_CONFUSE_RAY_1 ; BATTLE_ANIM_FRAMSET_CONFUSE_RAY_2
	jmp ReinitBattleAnimFrameset
...
.zero
	...
	ld hl, BATTLEANIMSTRUCT_VAR1
	add hl, bc
	add [hl] ; BATTLE_ANIM_FRAMSET_61 BATTLE_ANIM_FRAMSET_62
	         ; BATTLE_ANIM_FRAMSET_9C BATTLE_ANIM_FRAMSET_9D
	call ReinitBattleAnimFrameset
	ld hl, BATTLEANIMSTRUCT_PARAM
	add hl, bc
	ld a, [hl]
...
.one
	...
	add hl, bc
	ld a, [hl]
	inc a ; BATTLE_ANIM_FRAMSET_62
	      ; BATTLE_ANIM_FRAMSET_9D
	jr .got_frameset

.not_flipped
	ld hl, BATTLEANIMSTRUCT_VAR1
	add hl, bc
	ld a, [hl] ; BATTLE_ANIM_FRAMSET_61
	           ; BATTLE_ANIM_FRAMSET_9C
.got_frameset
	jmp ReinitBattleAnimFrameset

BattleAnimFunction_Amnesia:
; Creates 3 objects based on Obj Param
; Obj Param: How much to increase from base frameset, which is hardcoded as BATTLE_ANIM_FRAMSET_AMNESIA_1
...
.zero
	...
	add hl, bc
	ld a, [hl]
	add BATTLE_ANIM_FRAMSET_AMNESIA_1 ; BATTLE_ANIM_FRAMSET_AMNESIA_2 BATTLE_ANIM_FRAMSET_AMNESIA_3
	call ReinitBattleAnimFrameset
	ld hl, BATTLEANIMSTRUCT_PARAM
	add hl, bc
	ld e, [hl]
...
.zero
	...
	set OAM_Y_FLIP, [hl]
.not_param_zero
	add BATTLE_ANIM_FRAMSET_STRING_SHOT_1 ; BATTLE_ANIM_FRAMSET_STRING_SHOT_2 BATTLE_ANIM_FRAMSET_STRING_SHOT_3
	call ReinitBattleAnimFrameset
.one
	ret
...
.right
	...
	inc a
	ld [hl], a
	ld a, BATTLE_ANIM_FRAMSET_PARALYZED_FLIPPED
	jmp ReinitBattleAnimFrameset
...
.zero
	...
	ld a, [hl]
	and $7f
	add BATTLE_ANIM_FRAMSET_SPEED_LINE_1 ; BATTLE_ANIM_FRAMSET_SPEED_LINE_2 BATTLE_ANIM_FRAMSET_SPEED_LINE_3
	call ReinitBattleAnimFrameset
.one
	ld hl, BATTLEANIMSTRUCT_PARAM
	add hl, bc
...
; Object moves upward for $c frames and switches to BATTLE_ANIM_FRAMSET_SLUDGE_BUBBLE_BURST
	call BattleAnim_AnonJumptable
.anon_dw
	dw .zero
	dw .one
...
.done
	call BattleAnim_IncAnonJumptableIndex
	ld a, BATTLE_ANIM_FRAMSET_SLUDGE_BUBBLE_BURST
	call ReinitBattleAnimFrameset
.two
	ld hl, BATTLEANIMSTRUCT_YOFFSET
	add hl, bc
...
.zero
	...
	ld hl, BATTLEANIMSTRUCT_FRAMESET_ID
	add hl, bc
	add [hl] ; BATTLE_ANIM_FRAMSET_8F BATTLE_ANIM_FRAMSET_90 BATTLE_ANIM_FRAMSET_91
	         ; BATTLE_ANIM_FRAMSET_93 BATTLE_ANIM_FRAMSET_94 BATTLE_ANIM_FRAMSET_95
	call ReinitBattleAnimFrameset
	ld hl, BATTLEANIMSTRUCT_PARAM
	add hl, bc
	ld a, [hl]
