...
Pokedex_GBS_Stats:
	ld de, BS_HP_text
	hlcoord 3, 10
	rst PlaceString ; TEXT for 'HP' name

	ld de, BS_ATK_text
	hlcoord 3, 11
	rst PlaceString ; TEXT for 'ATK' name

	ld de, BS_DEF_text
	hlcoord 12, 11
	rst PlaceString ; TEXT for 'DEF' name

	ld de, BS_SPCL_text
	hlcoord 3, 12
	rst PlaceString ; TEXT for 'SPCL' name
...
;;; Print second egg group
	...
	call Pokedex_Get_EggGroup
	hlcoord 4, 12
	rst PlaceString ;no longer need to preserve bc
.EggGroups_DONE
	ret
.BS_Egg_text1:
	db "Egg Group: @"
