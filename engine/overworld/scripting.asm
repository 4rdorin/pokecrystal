...
; entries correspond to *_command constants (see macros/scripts/events.asm)
	...
	dw Script_LoadOverworldFont          ; b2
...
Script_sdefer:
; parameters: pointer. Priority jump.
