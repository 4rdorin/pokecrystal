...
; Print Move Accuracy
	...
	call Adjust_percent ; outputs accuracy in decimal instead of hex
	hlcoord 15, 12
...
; Place Move Effect Chance
	...
	call Scale256To100 ; outputs chance in decimal instead of hex
	hlcoord 15, 13
	ld [wTextDecimalByte], a
	ld de, wTextDecimalByte
	lb bc, 1, 3 ; number of bytes of num being printed in 'b', max digits in 'c'
...
.no_power
	ld de, String_MoveNullValue ; string for "---"
	rst PlaceString
