...
SetDefaultBattlePalette:
	...
	dec a ; PAL_BATTLE_BG_5 ICONS
	jr z, SetBattlePal_Icons
	dec a ; PAL_BATTLE_BG_6 ICONS
	jr z, SetBattlePal_Icons
...
SetBattlePal_Icons:
	...
	jmp LoadEnemyBattleCGBLayoutStatusIconPalette
...
; load the 1st type pal
	...
	call LoadMonBaseTypePal	; loads type color into slot 2 of pal 7
; mon type 2
	ld a, [wBaseType2]
	ld c, a ; farcall will clobber a for the bank
	ld a, [wBaseType1]
...
; load the 2nd type pal
	...
	call LoadMonBaseTypePal ; loads type color into slot 3 of pal 7
	jr .got_palette
.same_type
	ld de, wBGPals1 palette 7 + 4 ; slot 3 of pal 7
...
.loop
	...
	rst AddNTimes ; adds 'hl' to 'bc' number of times specified in 'a'
	ld e, l
	ld d, h
